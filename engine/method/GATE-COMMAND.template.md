<!--
  TEMPLATE — copy the block below ONCE to ~/.claude/commands/gate.md and
  fill in <vault-path>.
  Risk-based pre-commit quality gate: review lenses scale with the diff's
  risk, findings loop back as fix briefs, binary READY/NOT-READY verdict.
  Rationale and cycle cap: MULTI-AGENT.md.
-->
<!-- method-version: 4.0 -->

# /gate — risk-based pre-commit gate

Content for `~/.claude/commands/gate.md`:
...
- **Project checklist**: if `<vault-path>/projects/<project>/review-checklist.md`
