...
2. **Read the conventions supplied in the Task Brief** — only the entries
   relevant to this task. The parent resolves the hub/legacy convention index. Follow the patterns and structure the neighboring code already uses.
